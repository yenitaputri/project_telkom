                    ...
                    <tbody class="text-gray-600">
                        @forelse($salesWithTarget as $sale)
                            <tr class="border-t hover:bg-gray-100 transition">
                                ...
                                {{-- ACH% per produk --}}
                                <td class="px-2 py-2 text-left align-middle">
                                    {{ $sale->productAch['indibiz']['ach'] ?? 0 }} %
                                </td>
                                <td class="px-2 py-2 text-left align-middle">
                                    {{ $sale->productAch['wms']['ach'] ?? 0 }} %
                                </td>
                                <td class="px-2 py-2 text-left align-middle">
                                    {{ $sale->productAch['netmonk']['ach'] ?? 0 }} %
                                </td>
                                <td class="px-2 py-2 text-left align-middle">
                                    {{ $sale->productAch['oca']['ach'] ?? 0 }} %
                                </td>
                                <td class="px-2 py-2 text-left align-middle">
                                    {{ $sale->productAch['antarez']['ach'] ?? 0 }} %
                                </td>
                                <td class="px-2 py-2 text-left align-middle">
                                    {{ $sale->productAch['pijar_sekolah']['ach'] ?? 0 }} %
                                </td>
