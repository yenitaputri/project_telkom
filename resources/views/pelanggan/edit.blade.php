...
@section('content')
    <form action="{{ route('pelanggan.update', ['id' => $pelanggan['id'], $page => request('page', 1)]) }}" method="POST"
        class="space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-4 gap-4">
                    <div>
                        ...
                        <input type="text" id="datel" name="datel" value="{{ old('datel', $pelanggan['datel'] ?? '') }}"
                            class="w-full border border-gray-300 rounded px-4 py-2" />
                        @error('datel')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="ro" name="ro" value="{{ old('ro', $pelanggan['ro'] ?? '') }}"
                            class="w-full border border-gray-300 rounded px-4 py-2" />
                        @error('ro')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="sto" name="sto" value="{{ old('sto', $pelanggan['sto'] ?? '') }}"
                            class="w-full border border-gray-300 rounded px-4 py-2" />
                        @error('sto')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="grid grid-cols-4 gap-4">
                    <div>
                        ...
                        <input type="text" id="segmen" name="segmen" value="{{ old('segmen', $pelanggan['segmen'] ?? '') }}"
                            class="w-full border border-gray-300 rounded px-4 py-2" />
                        @error('segmen')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="kcontact" name="kcontact"
                            value="{{ old('kcontact', $pelanggan['kcontact'] ?? '') }}"
                            class="w-full border border-gray-300 rounded px-4 py-2" />
                        @error('kcontact')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="jenis_layanan" name="jenis_layanan"
                            value="{{ old('jenis_layanan', $pelanggan['jenis_layanan'] ?? '') }}"
                            class="w-full border border-gray-300 rounded px-4 py-2" />
                        @error('jenis_layanan')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="channel_1" name="channel_1"
                            value="{{ old('channel_1', $pelanggan['channel_1'] ?? '') }}"
                            class="w-full border border-gray-300 rounded px-4 py-2" />
                        @error('channel_1')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div>
                    ...
                    <select id="nama_sf" name="nama_sf" class="w-full border border-gray-300 rounded px-4 py-2">
                        ...
                        <option value="Bagas" {{ old('nama_sf', $pelanggan['nama_sf'] ?? '') == 'Bagas' ? 'selected' : '' }}>
                            Bagas</option>
                    </select>
                    @error('nama_sf')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                ...
                <div>
                    ...
                    <select id="agency" name="agency" class="w-full border border-gray-300 rounded px-4 py-2">
                        <option value="MCA" {{ old('agency', $pelanggan['agency'] ?? '') == 'MCA' ? 'selected' : '' }}>MCA
                        </option>
                        <option value="MCA2" {{ old('agency', $pelanggan['agency'] ?? '') == 'MCA2' ? 'selected' : '' }}>MCA2
                        </option>
                        <option value="MCA3" {{ old('agency', $pelanggan['agency'] ?? '') == 'MCA3' ? 'selected' : '' }}>MCA3
                        </option>
                    </select>
                    @error('agency')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
