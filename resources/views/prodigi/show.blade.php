            ...
            <table class="w-full text-sm text-left text-gray-700">
                <tbody>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="py-3 px-4">Joko Susilo</td>
                    </tr>
                    <tr class="border-b">
