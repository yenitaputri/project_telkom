...
<div class="bg-white rounded-lg shadow p-4 min-h-[calc(100vh-160px)] flex flex-col">
    ...
    <div class="overflow-x-auto">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mt-4 px-2 gap-y-2">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:space-x-4 w-full sm:w-auto justify-between sm:justify-end">
                <div>
        ...
        <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md transition-all">
            ...
            <form action="{{ route('sales.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                ...
                <div class="flex justify-end space-x-2 pt-4">
                    <button type="button" class="closeModalBtn px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-md text-sm font-medium transition-colors border border-gray-300">
                        Batal
                    </button>
                    <button type="submit"
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex flex-col items-center space-y-2">
                        <div class="w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center overflow-hidden">
                            ...
                            <svg id="placeholder-edit-icon" class="w-10 h-10 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4-8 3 6 2-4 3 6z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <div class="flex items-center w-full">
...
{{-- Modal Hapus --}}
<div id="deleteModal" class="fixed inset-0 z-50 flex items-center justify-center min-h-screen bg-gray-500 bg-opacity-75 transition-opacity" style="display: none;">
    {{-- Modal dialog --}}
